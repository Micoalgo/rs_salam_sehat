...
st.subheader("Apakah Owner dan Direktur RS Bingung dan Kesulitan melihat Progres Bisnis RS ? Apa yang harus dilakukan ? Mulai dari mana ? Sementara Biaya Rutin Operasional, Angsuran Alkes dan Biaya Lainnya harus terus keluar dan menggerus Cash flow RS")
