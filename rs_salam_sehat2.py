...
st.subheader("<h1 style='text-align: center;'>(Driving Hospital Revenue Growth Through Analytics)</h1>", unsafe_allow_html=True)
st.subheader(''':red[*(Driving Hospital Revenue Growth Through Analytics)*]''')
st.image("rs33b.png")
